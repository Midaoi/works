...
query.prototype.val=function(str){
	if(str||str==''){
		for(var i=0;i<this.elements.length;i++){
...
query.prototype.addClass=function(str){
	for(var i=0;i<this.elements.length;i++){
...
query.prototype.removeClass=function(str){
	for(var i=0;i<this.elements.length;i++){
		if(this.elements[i].className){
...
query.prototype.animate=function(json,options){
	for(var i=0;i<this.elements.length;i++){
...
;'click mouseover mouseout dblclick contextmenu mousedown mouseup mousemove keydown keyup'.replace(/\w+/g,function(str){
	query.prototype[str]=function(fn){
		for(var i=0;i<this.elements.length;i++){
...
query.prototype.mouseenter=function(fn){
	for(var i=0;i<this.elements.length;i++){
...
query.prototype.mouseleave=function(fn){
	for(var i=0;i<this.elements.length;i++){
...
query.prototype.hover=function(fn1,fn2){
	this.mouseenter(fn1);
	this.mouseleave(fn2);
};
